...
def print_banner():
   ...
   / __ \____ ______/ /____    _________                     
  / /_/ / __ `/ ___/ __/ _ \  / ___/ __ \                    
 / ____/ /_/ (__  ) /_/  __/ (__  ) /_/ /                    
/_/ ___\__,_/____/\__/\___(_)____/\____/    _                
...
while True:
    ...
    while (number_of_attempts == 0 and not successful_urls) or (number_of_attempts > 0 and len(successful_urls) < number_of_attempts):
        link = "https://paster.so/"
        random_end = ''.join(random.choice(string.ascii_letters + string.digits) for _ in range(4))
        url = link + random_end
